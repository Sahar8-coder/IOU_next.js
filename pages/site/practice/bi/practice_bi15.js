...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x4 − 37x2 + 36 = 0\\). Корни укажите через точку с запятой',
        isText: true,
        answerOptions: [
            {answerText: '6;6;1;-1'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(16x4 − 32x2 − 9 = 0\\). Корни укажите через точку с запятой',
        isText: true,
        answerOptions: [
            {answerText: '1.5;-1.5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            ...
            <h2 className="types-header">Биквадратные уравнения 15</h2>
                <div className="test">
                {
                    showScore
