...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(x4 − 53x2 + 196 = 0\\). Корни укажите через точку с запятой',
        isText: true,
        answerOptions: [
            {answerText: '7;-7;2;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x4 − 99x2 − 100 = 0\\). Корни укажите через точку с запятой',
        isText: true,
        answerOptions: [
            {answerText: '10;-10'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x4 − 5x2 − 36 = 0\\). Корни укажите через точку с запятой',
        isText: true,
        answerOptions: [
            {answerText: '3;-3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            ...
            <h2 className="types-header">Биквадратные уравнения 18</h2>
                <div className="test">
                {
                    showScore
