...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−7x^2 − 13x − 6 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-6/7'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(2x^2 − 15x + 13 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;6.5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−11x^2 + 14x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;3/11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−9x^2 − 8x + 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;1/9'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(5x^2 + 17x + 12 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;2.4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 17</h2>
                <div className="test">
                {
                    showScore
