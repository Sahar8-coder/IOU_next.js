...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−13x^2 + 11x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-2/13'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−14x^2 + x + 13 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;-13/14'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−x^2 − 9x − 8 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(15x^2 + 26x + 11 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;-11/15'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 11</h2>
                <div className="test">
                {
                    showScore
