...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−15x^2 + 7x + 8 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-8/15'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−5x^2 + 6x − 1 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;0.2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−4x^2 + 9x + 13 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-3.25'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(11x^2 + 10x − 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;1/11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−13x^2 + x + 12 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;-12/13'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 9</h2>
                <div className="test">
                {
                    showScore
