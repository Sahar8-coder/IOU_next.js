...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(8x^2 + 9x − 17 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-17/8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−11x^2 + 3x + 14 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;14/11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−2x^2 + 7x + 9 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-4.5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−5x^2 − 2x + 7 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;-1.4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 15</h2>
                <div className="test">
                {
                    showScore
