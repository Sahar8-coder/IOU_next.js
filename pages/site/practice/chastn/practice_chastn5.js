...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(2x^2 − 3x − 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-2.5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−9x^2 − 23x − 14 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;-14/9'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−14x^2 − x + 15 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-15/14'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(11x^2 + 13x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-2/11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−7x^2 + 10x − 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;3/7'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 5</h2>
                <div className="test">
                {
                    showScore
