...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−x^2 − 5x − 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 − x − 7 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-7/8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(3x^2 − 7x − 10 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;10/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 − 9x + 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;1/8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−5x^2 − 8x + 13 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;-2.6'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 20</h2>
                <div className="test">
                {
                    showScore
