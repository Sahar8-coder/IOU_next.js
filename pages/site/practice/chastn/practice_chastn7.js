...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(11x^2 + x − 12 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-12/11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(2x^2 + 9x + 7 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;3.5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−9x^2 + x + 8 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-8/9'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 5x − 6 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-6'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 13x + 7 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;7/6'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 7</h2>
                <div className="test">
                {
                    showScore
