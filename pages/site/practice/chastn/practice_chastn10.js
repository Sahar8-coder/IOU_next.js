...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−8x^2 − 13x − 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-5/8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−x^2 − 13x − 12 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;12'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−7x^2 + 2x + 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-5/7'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 5x − 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-1/6'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(10x^2 + x − 9 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;-0.9'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 10</h2>
                <div className="test">
                {
                    showScore
