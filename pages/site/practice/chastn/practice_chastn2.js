...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−4x^2 − 3x + 7 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-1.75'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(13x^2 + 4x − 17 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1;-17/13'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(3x^2 + 2x − 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1;1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−15x^2 + 13x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1;-2/15'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−4x^2 + x + 5 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1;-1.25'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Частные случаи 2</h2>
                <div className="test">
                {
                    showScore
