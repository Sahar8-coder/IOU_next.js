...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(-\\frac{4}{9}x^2 - \\frac{1}{8}x = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '0;-9/32'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(13x^2 + 5x = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '0;-5/13'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 − 19 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: false,
        answerOptions: [
            {answerText: '\\(\\frac{\\sqrt{9}}{\\sqrt{2}}; -\\frac{\\sqrt{9}}{\\sqrt{2}}\\)', isCorrect: false},
            {answerText: '\\(\\frac{\\sqrt{19}}{5\\sqrt{5}}; -\\frac{\\sqrt{19}}{5\\sqrt{5}}\\)', isCorrect: false},
            {answerText: '\\(\\frac{\\sqrt{19}}{2\\sqrt{2}}; -\\frac{\\sqrt{19}}{2\\sqrt{2}}\\)', isCorrect: true},
            {answerText: '\\(\\frac{\\sqrt{19}}{4}; -\\frac{\\sqrt{19}}{4}\\)', isCorrect: false}
        ]
    },
    {
    ...
    {
        questionText: 'Решите уравнение \\(11x^2 + 5 = 0\\).',
        isText: true,
        answerOptions: [
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Неполные квадратные уравнения 14</h2>
                <div className="test">
                {
                    showScore
