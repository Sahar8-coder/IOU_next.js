  ...
  const questions = [
    {
        ...
        isText: false,
        answerOptions: [
            {answerText: '\\(\\frac{3\\sqrt{2}}{19}; -\\frac{3\\sqrt{2}}{19}\\)', isCorrect: false},
            {answerText: '\\(\\frac{3}{\\sqrt{19}}; -\\frac{3}{\\sqrt{19}}\\)', isCorrect: false},
            {answerText: '\\(\\frac{3\\sqrt{19}}{\\sqrt{2}}; -\\frac{3\\sqrt{19}}{\\sqrt{2}}\\)', isCorrect: false},
            {answerText: '\\(\\frac{3\\sqrt{2}}{\\sqrt{19}}; -\\frac{3\\sqrt{2}}{\\sqrt{19}}\\)', isCorrect: true},
        ]
    },
    {
    ...
    {
        questionText: 'Решите уравнение \\(\\frac{1}{2}x^2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите 6x^2 − 11x − 10 = 0 из них.',
        isText: true,
        answerOptions: [
            {answerText: '0'},
        ]
...
<header className="header">
        ...
        <main className="main">
            ...
            </Link>Неполные квадратные уравнения 4</h2>
                <div className="test">
                {
                    showScore
