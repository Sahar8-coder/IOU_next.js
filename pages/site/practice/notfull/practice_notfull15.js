...
const config = {
  ...
  const questions = [
    ...
    },
    {
        ...
        isText: false,
        answerOptions: [
            {answerText: '\\(\\frac{3}{13}}; -\{\\frac{3}{13}}\\)', isCorrect: false},
            {answerText: '\\(\\sqrt{\\frac{3}{13}}; -\\sqrt{\\frac{3}{13}}\\)', isCorrect: true},
            {answerText: '\\(\\sqrt{\\frac{13}{3}}; -\\sqrt{\\frac{13}{3}}\\)', isCorrect: false},
            {answerText: '\\(\\sqrt{13}; -\\sqrt{13}}\\)', isCorrect: false}
        ]
    }
  ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Неполные квадратные уравнения 15</h2>
                <div className="test">
                {
                    showScore
