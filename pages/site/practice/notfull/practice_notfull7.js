...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(-0.5x^2 + \\frac{1}{9}x = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '0;2/9'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−6x^2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '0'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(15x^2 = −13\\).',
        isText: true,
        answerOptions: [
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Неполные квадратные уравнения 7</h2>
                <div className="test">
                {
                    showScore
