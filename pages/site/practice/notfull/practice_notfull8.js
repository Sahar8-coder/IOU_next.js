...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(12x^2 − 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: false,
        answerOptions: [
            {answerText: '\\(\\frac{\\sqrt{2}}{2\\sqrt{3}}; -\\frac{\\sqrt{2}}{2\\sqrt{3}}\\)', isCorrect: false},
            {answerText: '\\(\\frac{5}{2\\sqrt{3}}; -\\frac{5}{2\\sqrt{3}}\\)', isCorrect: false},
            {answerText: '\\(\\frac{\\sqrt{5}}{2\\sqrt{3}}; -\\frac{\\sqrt{5}}{2\\sqrt{3}}\\)', isCorrect: true},
            {answerText: '\\(\\frac{\\sqrt{5}}{2*3}; -\\frac{\\sqrt{5}}{2*3}\\)', isCorrect: false}
        ]
    },
    {
        questionText: 'Решите уравнение \\(-\\frac{6}{11}x^2 + \\frac{1}{9}x = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '0;11/54'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(19x^2 + 10 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
    ...
    {
        questionText: 'Решите уравнение \\(−8x^2 − 7x = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '0;-7/8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(\\frac{1}{6}x^2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '0'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Неполные квадратные уравнения 8</h2>
                <div className="test">
                {
                    showScore
