...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − x − 6 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '3;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 4x − 77 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '11;-7'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 6</h2>
                <div className="test">
                {
                    showScore
