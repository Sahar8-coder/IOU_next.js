...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − x − 42 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-7;-6'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 19x + 34 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '17;2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 7x − 44 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '4;-11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 14x + 33 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '3;-11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − x − 90 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '10;-9'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 13</h2>
                <div className="test">
                {
                    showScore
