...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 + 3x − 88 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '8;-11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 7x − 98 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '14;-7'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 2x − 15 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '3;-5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 15</h2>
                <div className="test">
                {
                    showScore
