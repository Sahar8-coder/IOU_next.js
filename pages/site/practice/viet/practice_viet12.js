...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 20x + 64 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '16;4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 14x − 95 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '19;-5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 12</h2>
                <div className="test">
                {
                    showScore
