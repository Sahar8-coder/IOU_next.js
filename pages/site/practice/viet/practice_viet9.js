...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − x − 30 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '6;-5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 8x − 20 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '10;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 2x − 99 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '9;-11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 23x + 90 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '18;5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 16x − 36 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '18;-2'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 9</h2>
                <div className="test">
                {
                    showScore
