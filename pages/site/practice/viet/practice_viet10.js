...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 + 20x + 51 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3;-17'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 19x + 60 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '15;4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 7x + 10 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '5;2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 13x + 30 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3;-10'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 7x + 12 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3;-4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 10</h2>
                <div className="test">
                {
                    showScore
