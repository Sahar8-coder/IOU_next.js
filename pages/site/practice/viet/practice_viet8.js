...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 12x + 35 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-5;-7'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 21x + 68 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '17;4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 22x + 96 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '16;6'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 15x + 44 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-4;-11'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 8</h2>
                <div className="test">
                {
                    showScore
