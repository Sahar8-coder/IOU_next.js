...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − 8x − 33 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '11;-3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 18x + 56 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-4;-14'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 17x + 72 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '9;8'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 10x + 24 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '6;5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 16</h2>
                <div className="test">
                {
                    showScore
