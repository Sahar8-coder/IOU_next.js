...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − 8x + 12 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '6;2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 6x − 16 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '8;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 20x + 36 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '18;2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 11x − 60 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '15;-4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 13x + 36 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '9;4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 19</h2>
                <div className="test">
                {
                    showScore
