...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 + 4x − 60 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '6;-10'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 16x + 48 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '12;4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 9x − 90 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '6;-15'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 14x − 32 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '2;-16'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 11</h2>
                <div className="test">
                {
                    showScore
