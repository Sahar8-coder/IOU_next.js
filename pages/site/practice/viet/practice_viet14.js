...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − 19x + 90 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '10;9'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 2x − 80 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '8;-10'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 12x − 64 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '16;-4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 14</h2>
                <div className="test">
                {
                    showScore
