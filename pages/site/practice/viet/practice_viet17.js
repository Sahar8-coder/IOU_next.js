...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 17x + 66 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '11;6'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 9x + 18 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-6;3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 17</h2>
                <div className="test">
                {
                    showScore
