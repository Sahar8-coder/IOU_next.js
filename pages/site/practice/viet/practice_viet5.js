...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 + 8x + 15 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3;-5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 9x − 22 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '11;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 18x − 40 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '2;-20'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 15x + 56 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '8;7'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 5</h2>
                <div className="test">
                {
                    showScore
