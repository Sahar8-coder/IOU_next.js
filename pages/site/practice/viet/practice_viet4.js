...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 + 13x + 22 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2;-11'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 10x − 96 = 0\\). Если уравнение имеет более одного корня, в ответ запишите 6x2 − 11x − 10 = 0 из них.',
        isText: true,
        answerOptions: [
            {answerText: '16;-6'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 4</h2>
                <div className="test">
                {
                    showScore
