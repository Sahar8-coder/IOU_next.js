...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 + 24x + 95 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-5;-19'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 21x + 38 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2;-19'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 12x − 45 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '15;-3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 6x − 91 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '7;-13'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 + 17x + 52 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-4;-13'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 18</h2>
                <div className="test">
                {
                    showScore
