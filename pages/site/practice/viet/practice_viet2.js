...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(x^2 − 10x + 16 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '8;2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 15x + 36 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '12;3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Теорема Виета 2</h2>
                <div className="test">
                {
                    showScore
