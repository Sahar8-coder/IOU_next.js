...
const config = {
  ...
  const questions = [
    {
        questionText: 'Разложите на множители \\(3x^2 + x − 2\\).',
        isText: true,
        answerOptions: [
            {answerText: '(x+1)(3x-2)'},
        ]
    ...
    {
        questionText: 'Разложите на множители \\(x^2 + 8x − 84\\).',
        isText: true,
        answerOptions: [
            {answerText: '(x+14)(x-6)'},
        ]
    ...
    {
        questionText: 'Разложите на множители \\(7x^2 − 6x − 13\\).',
        isText: true,
        answerOptions: [
    ...
    {
        questionText: 'Разложите на множители \\(20x^2 + 21x + 4\\).',
        isText: true,
        answerOptions: [
...
<header className="header">
        ...
        <main className="main">
            ...
            </Link>Разложение на множители 2</h2>
                <div className="test">
                {
                    showScore
