...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(8x^2 − 21x + 10\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '(8x−5)(x−2)'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(13x^2 + 10x − 3\\).',
        isText: true,
        answerOptions: [
            {answerText: '(x+1)(13x−3)'},
        ]
    },
    {
        questionText: 'Решите уравнение \\(2x^2 + 19x + 44\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '(2x+11)(x+4)'},
        ]
    },
    {
        questionText: 'Решите уравнение \\(16x^2 + 38x + 15\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '(8x+15)(2x+1)'},
        ]
    },
    {
        questionText: 'Решите уравнение \\(−4x^2 + 45x − 104\\).',
        isText: true,
        answerOptions: [
            {answerText: '−(4x−13)(x−8)'},
        ]
    }
  ]
...
<header className="header">
        ...
        <main className="main">
            ...
            </Link>Разложение на множители 11</h2>
                <div className="test">
                {
                    showScore
