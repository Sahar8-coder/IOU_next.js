...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(9x^2 − 3x − 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '2/3;-1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(2x^2 + 13x + 20 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-5/2;-4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−9x^2 + 9x − 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/3;2/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(15x^2 + 2x − 8 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '2/3;-4/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(20x^2 + 3x − 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1/4;-2/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 12</h2>
                <div className="test">
                {
                    showScore
