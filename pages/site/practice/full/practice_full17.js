...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−12x^2 + 19x − 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/4;4/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−16x^2 − 8x + 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3/4;1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−12x^2 + 11x − 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/4;2/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(4x^2 + 4x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/2;-3/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(12x^2 − 13x − 4 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '4/3;-1/4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 17</h2>
                <div className="test">
                {
                    showScore
