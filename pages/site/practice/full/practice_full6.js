...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(−5x^2 + 13x + 6 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2/5;3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−15x^2 − x + 6 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-2/3;3/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−20x^2 + 11x + 4 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/4;4/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 6</h2>
                <div className="test">
                {
                    showScore
