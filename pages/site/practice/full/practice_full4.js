...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(2x^2 + 7x − 15 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '3/2;-5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−6x^2 + 11x + 10 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2/3;5/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−2x^2 + 13x − 20 = 0\\). Если уравнение имеет более одного корня, в ответ запишите 6x2 − 11x − 10 = 0 из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/2;4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−5x^2 + 18x + 8 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2/5;4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 4</h2>
                <div className="test">
                {
                    showScore
