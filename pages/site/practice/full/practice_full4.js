...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(−2x^2 + 13x − 20 = 0\\). Если уравнение имеет более одного корня, в ответ запишите 6x^2 − 11x − 10 = 0 из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/2;4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            ...
            </Link>Полные квадратные уравнения 4</h2>
                <div className="test">
                {
                    showScore
