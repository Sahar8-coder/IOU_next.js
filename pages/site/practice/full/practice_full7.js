...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−10x^2 − 3x + 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-4/5;1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 7x − 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '3/2;-1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 + 22x + 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/3;-5/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−16x^2 − 16x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-3/4;-1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−25x^2 + 10x + 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;3/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 7</h2>
                <div className="test">
                {
                    showScore
