...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−20x^2 − 11x + 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-4/5;1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−4x^2 + 7x + 15 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-5/4;3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 11x + 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '4/3;1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−8x^2 − 18x + 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-5/2;1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(15x^2 + 22x + 8 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2/3;-4/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 20</h2>
                <div className="test">
                {
                    showScore
