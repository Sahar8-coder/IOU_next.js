...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(20x^2 − 11x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '3/4;-1/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(10x^2 + 19x + 6 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2/5;-3/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−15x^2 + 16x − 4 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '2/5;2/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 11</h2>
                <div className="test">
                {
                    showScore
