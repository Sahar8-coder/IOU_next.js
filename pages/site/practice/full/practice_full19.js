...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−15x^2 + 7x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;2/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(12x^2 + 19x + 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/3;-5/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − x − 1 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1/2;-1/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 19</h2>
                <div className="test">
                {
                    showScore
