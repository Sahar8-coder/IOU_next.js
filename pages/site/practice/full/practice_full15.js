...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−8x^2 − 2x + 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/2;1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − x − 15 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '5/3;-3/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−20x^2 + 7x + 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/4;3/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 15</h2>
                <div className="test">
                {
                    showScore
