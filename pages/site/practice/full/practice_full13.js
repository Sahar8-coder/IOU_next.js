...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(2x^2 + 5x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/2;-3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−10x^2 − 9x − 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/2;-2/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 + 18x − 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/4;-5/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(9x^2 + 9x − 10 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '2/3;-5/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 13</h2>
                <div className="test">
                {
                    showScore
