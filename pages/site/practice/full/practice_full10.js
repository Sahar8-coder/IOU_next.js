...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−20x^2 − 21x − 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-4/5;-1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(15x^2 − 11x + 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '2/5;1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 7x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '3/2;-1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−15x^2 + 19x − 6 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '3/5;2/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 + 5x − 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/2;-4/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 10</h2>
                <div className="test">
                {
                    showScore
