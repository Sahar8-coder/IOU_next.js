...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(4x^2 + 5x − 6 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '3/4;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−20x^2 + 11x + 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;3/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−3x^2 − 20x − 25 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-5;-5/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−20x^2 − x + 1 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/4;1/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 16</h2>
                <div className="test">
                {
                    showScore
