...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−6x^2 − 5x − 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/2;-1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 + 2x − 1 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1/4;-1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(25x^2 + 5x − 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/5;-2/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(3x^2 + 7x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/3;-2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−4x^2 − 11x + 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3;1/4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Полные квадратные уравнения 5</h2>
                <div className="test">
                {
                    showScore
