...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 11x − 10 = 0\\). Если уравнение имеет более одного корня, в ответ запишите 6x^2 − 11x − 10 = 0 из них.',
        isText: true,
        answerOptions: [
            {answerText: '2.5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            ...
            </Link>Квадратные уравнения из банка ЕГЭ 4</h2>
                <div className="test">
                {
                    showScore
