...
const config = {
  ...
  const [submitted, setSubmitted] = useState(false)
   const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(x^2 − 14x + 49 = 0\\). При наличии дроби, ответ запишите через /',
        isText: true,
        answerOptions: [
            {answerText: '7'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Квадратные уравнения с одним корнем 16</h2>
                <div className="test">
                {
                    showScore
