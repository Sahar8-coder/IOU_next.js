...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(10x^2 + 19x + 6 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-2/5;-3/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−6x^2 + 5x + 4 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/2;4/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−10x^2 + 13x − 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/2;4/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(25x^2 + 15x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;-2/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−12x^2 + x + 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/4;1/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 10</h2>
                <div className="test">
                {
                    showScore
