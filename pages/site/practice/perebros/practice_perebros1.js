...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(−10x^2 − x + 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-3/5;1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(25x^2 − 10x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '3/5;-1/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(2x^2 − 3x − 20 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '4;-5/2'},
        ]
  ...
  return (
    ...
    <Head>
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 1</h2>
                <div className="test">
                {
                    showScore
