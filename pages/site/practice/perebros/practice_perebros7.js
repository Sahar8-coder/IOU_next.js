...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−5x^2 − 14x − 8 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '0.25'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(10x^2 − 17x + 3 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2;-4/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−2x^2 − 5x + 25 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-5;5/2'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 7</h2>
                <div className="test">
                {
                    showScore
