...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−2x^2 + 15x − 25 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/2;5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−12x^2 + 11x − 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1/4;2/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(10x^2 − 9x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/2;2/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(12x^2 + 5x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите 6x^2 − 11x − 10 = 0 из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/3;-3/4'},
        ]
