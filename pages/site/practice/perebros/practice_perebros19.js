...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(5x^2 + 17x + 6 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2/5;-3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(4x^2 + 17x + 15 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-5/4;-3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(12x^2 + 7x + 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/4;-1/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(20x^2 − 21x + 4 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '4/5;1/4'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 19</h2>
                <div className="test">
                {
                    showScore
