...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−4x^2 − 13x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-3;-1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−8x^2 + 10x − 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/2;3/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(3x^2 + 10x − 25 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/3;-5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 + 19x + 15 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-3/2;-5/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−2x^2 − 5x + 12 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-4;3/2'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 20</h2>
                <div className="test">
                {
                    showScore
