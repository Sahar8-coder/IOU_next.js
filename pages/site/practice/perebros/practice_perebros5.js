...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(−3x^2 + 19x − 20 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '4/3;5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(2x^2 − 5x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '2;1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 + 2x − 1 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/4;-1/2'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 5</h2>
                <div className="test">
                {
                    showScore
