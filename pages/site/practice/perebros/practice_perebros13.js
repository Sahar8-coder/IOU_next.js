...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−2x^2 + x + 15 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-5/2;3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 + 7x − 5 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1/2;-5/3'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(5x^2 + 21x + 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;-4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(15x^2 + x − 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '1/3;-2/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−10x^2 − x + 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/2;2/5'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 13</h2>
                <div className="test">
                {
                    showScore
