...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(10x^2 + 17x + 3 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;-3/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(8x^2 − 22x + 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/2;1/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(9x^2 + 12x − 5 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '1/3;-5/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 11</h2>
                <div className="test">
                {
                    showScore
