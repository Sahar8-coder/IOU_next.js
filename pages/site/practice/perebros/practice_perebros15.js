...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(8x^2 − 6x − 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/4;-1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−8x^2 − 6x + 9 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-3/2;3/4'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−15x^2 + 7x + 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-1/5;2/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 15</h2>
                <div className="test">
                {
                    showScore
