...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение \\(−15x^2 + 7x + 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите больший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/3;4/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−2x^2 − 3x + 2 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '-2;1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−6x^2 + x + 2 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-1/2;2/3'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 9</h2>
                <div className="test">
                {
                    showScore
