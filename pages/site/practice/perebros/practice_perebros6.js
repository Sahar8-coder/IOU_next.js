...
const config = {
  ...
  const questions = [
    ...
    {
        questionText: 'Решите уравнение \\(4x^2 − 8x − 5 = 0\\).',
        isText: true,
        answerOptions: [
            {answerText: '5/2;-1/2'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(−15x^2 − 4x + 4 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '-2/3;2/5'},
        ]
    ...
    {
        questionText: 'Решите уравнение \\(6x^2 − 13x + 5 = 0\\). Если уравнение имеет более одного корня, в ответ запишите меньший из них.',
        isText: true,
        answerOptions: [
            {answerText: '5/3;1/2'},
        ]
...
<header className="header">
        ...
        <main className="main">
            <div className="content_main_test"><h2 className="types-header">Метод переброски 6</h2>
                <div className="test">
                {
                    showScore
