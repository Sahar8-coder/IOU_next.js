...
const config = {
  ...
  const questions = [
    {
        questionText: 'Решите уравнение и выберите верный ответ \\(x^2 − 20x + 69 = 0\\).',
        isText: false,
        answerOptions: [
            {answerText: '\\(20 - \\sqrt{33}; 20 + \\sqrt{33}\\)', isCorrect: false},
            {answerText: '\\(10 - \\sqrt{33}; 10 + \\sqrt{33}\\)', isCorrect: false},
            {answerText: '\\(20 - \\sqrt{31}; 20 + \\sqrt{31}\\)', isCorrect: false},
            {answerText: '\\(10 - \\sqrt{31}; 10 + \\sqrt{31}\\)', isCorrect: true}
        ]
    },
    {
        questionText: 'Решите уравнение и выберите верный ответ \\(9x^2 − 12x + 1 = 0\\).',
        isText: false,
        answerOptions: [
            {answerText: '\\(\\frac{4 - \\sqrt2}{3}; \\frac{4 + \\sqrt2}{3}\\)', isCorrect: false},
            {answerText: '\\(\\frac{2 - \\sqrt3}{3}; \\frac{2 + \\sqrt3}{3}\\)', isCorrect: true},
            {answerText: '\\(\\frac{4 - \\sqrt3}{3}; \\frac{4 + \\sqrt3}{3}\\)', isCorrect: false},
            {answerText: '\\(\\frac{2 - \\sqrt2}{3}; \\frac{2 + \\sqrt2}{3}\\)', isCorrect: false}
        ]
    },
    {
        questionText: 'Решите уравнение и выберите верный ответ \\((−x + 10)(3x + 8) = 0\\).',
        isText: false,
        answerOptions: [
            {answerText: '\\(10; -\\frac{7}{3}\\)', isCorrect: false},
            {answerText: '\\(20; -\\frac{8}{3}\\)', isCorrect: false},
            {answerText: '\\(10; -\\frac{8}{3}\\)', isCorrect: true},
            {answerText: '\\(20; -\\frac{7}{3}\\)', isCorrect: false}
        ]
    },
    {
        questionText: 'Решите уравнение и выберите верный ответ \\(\\frac{5}{8}x^2 + \\frac{1}{4} − \\frac{13}{16}x = 0\\).',
        isText: false,
        answerOptions: [
            {answerText: '\\(\\frac{4}{5}; \\frac{1}{2}\\)', isCorrect: true},
            {answerText: '\\(\\frac{2}{5}; \\frac{1}{3}\\)', isCorrect: false},
            {answerText: '\\(\\frac{4}{5}; \\frac{1}{3}\\)', isCorrect: false},
            {answerText: '\\(\\frac{2}{5}; \\frac{1}{2}\\)', isCorrect: false}
        ]
    },
    {
        questionText: 'Решите уравнение и выберите верный ответ \\(x^2 - 10x\\sqrt{2} + 48 = 0\\).',
        isText: false,
        answerOptions: [
            {answerText: '\\(2\\sqrt3; 6\\sqrt3\\)', isCorrect: false},
            {answerText: '\\(2\\sqrt2; 6\\sqrt2\\)', isCorrect: false},
            {answerText: '\\(4\\sqrt2; 6\\sqrt2\\)', isCorrect: true},
            {answerText: '\\(4\\sqrt3; 6\\sqrt3\\)', isCorrect: false}
        ]
    }
  ]
...
<header className="header">
        ...
        <main className="main">
            ...
            </Link>Квадратные уравнения, имеющие корни — радикалы 2</h2>
                <div className="test">
                {
                    showScore
